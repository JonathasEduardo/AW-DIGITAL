...
public class ClienteService {
    ...
    public Cliente findById(Integer id){
        ...
        return cat.orElseThrow(() -> new ObjectNoteFoundException("Categoria não encontrado !!"));
    }
    ...
    public void delete(Integer id){
        ...
        if(cat.get().getLoja().size() > 0){
            throw new DataIntegrityViolationException("Existe livros nessa categoria, NÃO PODE SER DELETADA");
        }
